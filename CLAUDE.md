...
```mermaid
graph TD
  8f3c7453["ERC-721 NFT"]
  6bba2410["Frontend"]
  4a9376ef["Wallet Auth"]
  8f3c7453 --> 6bba2410
  6bba2410 --> 4a9376ef
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--8f3c7453.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--6bba2410.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--4a9376ef.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--8f3c7453.md)
- [Frontend](.nskills/components/frontend-scaffold--6bba2410.md)
- [Wallet Auth](.nskills/components/wallet-auth--4a9376ef.md)
