      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="flex items-center justify-center gap-2 text-sm font-medium text-slate-800 sm:justify-start">
            ...
            ERC-1155 interactions coming in the next update
          </p>
          <p className="mt-1 text-xs text-slate-600">
            Batch mint, balance queries, and multi-id support will appear here.
          </p>
        </div>
      </div>
    </div>
