      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="flex items-center justify-center gap-2 text-sm font-medium text-slate-800 sm:justify-start">
            ...
            EIP-2981 royalty tooling coming in the next update
          </p>
          <p className="mt-1 text-xs text-slate-600">
            On-chain royalty configuration for secondary sales will be added
            here.
          </p>
        </div>
      </div>
